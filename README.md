# Portfólio Pessoal - Atividade MAPA

Projeto desenvolvido como parte da **Atividade MAPA da disciplina de Programação Front-End**, com o objetivo de criar uma Landing Page pessoal utilizando **HTML semântico** e **CSS puro**.
...
[Ver página online](https://b4sileus-py.github.io/NOME-DO-REPOSITORIO/)
...
* Criação de layout visualmente organizado
...
* `<header>`: usado para o cabeçalho da página, contendo foto, nome, frase e menu.
* `<nav>`: usado para a navegação interna entre as seções.
* `<main>`: usado para envolver o conteúdo principal da página.
* `<section>`: usado para separar os blocos “Sobre mim”, “Habilidades” e “Projetos”.
* `<article>`: usado para apresentar cada projeto de forma individual.
...
Foram utilizadas cores escuras no fundo e tons de destaque em verde, roxo, azul claro, rosa e amarelo. A ideia foi criar uma aparência ligada ao universo da programação, com contraste forte e estilo visual marcante.
...
Projeto prático desenvolvido com HTML e CSS puro para organizar uma lista pessoal de filmes e jogos favoritos em formato de catálogo. O objetivo foi praticar seções, imagens, cards, responsividade e pequenos efeitos visuais com CSS.

### Landing Page para Negócio Local
